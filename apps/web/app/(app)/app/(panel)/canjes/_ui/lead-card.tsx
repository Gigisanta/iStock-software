...
const STATUS_CLASS: Readonly<Record<string, string>> = {
  ...
  contacted: 'bg-sky-100 text-sky-900 dark:bg-sky-900/40 dark:text-sky-100',
  evaluating: 'bg-amber-100 text-amber-900 dark:bg-amber-900/40 dark:text-amber-100',
...
export function LeadCard({ lead }: { lead: TradeinLead }) {
  ...
  return (
    <li className="rounded-2xl border border-neutral-200 bg-white dark:border-neutral-800 dark:bg-neutral-900">
      <Link
