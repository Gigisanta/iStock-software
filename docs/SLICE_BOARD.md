...
de media lo comprueba sobre HTTP. El CDN productivo `img.maat.work` es externo a este repo y su
header sigue **UNVERIFIED** hasta inspeccionarlo después de desplegar R2; eso no se tapa con la ruta
local.
